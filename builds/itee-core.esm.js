console.log('Itee.Core v1.1.0 - EsModule')
...
export { Colors, CubeRootOfFive, CubeRootOfFour, CubeRootOfHeight, CubeRootOfNine, CubeRootOfSeven, CubeRootOfSix, CubeRootOfTen, CubeRootOfThree, CubeRootOfTwo, DefaultLogger, Directions, Eleven, Fifteen, Fifty, FileFormat, Five, FiveHundred, FivePi, Four, FourPi, Fourteen, Fourty, Height, HeightPi, Heighteen, Heighty, HttpStatusCode, HttpVerb, Keys, MimeType, Mouse, Nine, NinePi, Nineteen, Ninety, One, OneFourth, OneHalf, OneHundred, OneHundredThousand, OneMillion, OneThird, OneThousand, Pi, PiOnFive, PiOnFour, PiOnHeight, PiOnNine, PiOnSeven, PiOnSix, PiOnTen, PiOnThree, PiOnTwo, ResponseType, Seven, SevenPi, Seventeen, Seventy, Six, SixPi, Sixteen, Sixty, SquareRootOfFive, SquareRootOfFour, SquareRootOfHeight, SquareRootOfNine, SquareRootOfSeven, SquareRootOfSix, SquareRootOfTen, SquareRootOfThree, SquareRootOfThreeOnTwo, SquareRootOfTwo, SquareRootOfTwoOnTwo, TAbstractObject, TLogger, Ten, TenPi, TenThousand, Thirteen, Thirty, Three, ThreeFourth, ThreePi, Twelve, Twenty, Two, TwoFourth, TwoPi, TwoThird, Zero };
